    ...
    <section>
        ...
        <div className="project-items">
            <div className="project-each-item">
                ...
                <h3>Singh Shop</h3>
                <p>This is simple E-commerce website in which there is it 's own products api and after login or signUp you will be able to save products and also can do add to Cart. It is tottaly created by React js. And the Backend part is through Node js and MongooDB. </p>
                <div className="projects-links">
                    <a className="icon" href="https://github.com/Singhji2003/singh-shop-frotend" target="_singh"><i className="fa-brands fa-github-alt"></i></a>
                    <a className="icon" href="https://singhshop.netlify.app/" target="_singh"><i className="fa-solid fa-arrow-up-right-from-square"> </i></a>
                </div>
            </div>
            <div className="project-each-item">
        ...
        <div className="project-items">
            ...
            <div className="project-each-item">
                ...
                <div className="projects-links">
                    ...
                    <a className="icon" href="https://singhji.netlify.app/" target="_singh"><i className="fa-solid fa-arrow-up-right-from-square"> </i></a>
                </div>
            </div>
        </div>
        <div className="project-items">
        ...
        <div className="project-each-item">
            ...
            <div className="project-each-item">
                ...
                <p>This is simple a home page of this website which I created just for fun. It is by pure HTML,CSS and JS. </p>
                <div className="projects-links">
                    <a className="icon" href="https://singhbuilding.netlify.app/" target="_singh"><i className="fa-solid fa-arrow-up-right-from-square"> </i></a>
                </div>
            </div>
        </div>
        </div>
