      ...
      <div className="main-heading">
        <div className="naming-heading">
          ...
          <div className="social-media-icons">
            <a
              className="icon"
              href="https://www.facebook.com/profile.php?id=100070711231550"
              target="_singh"
            >
            ...
            <a
              className="icon"
              href="https://www.linkedin.com/in/arpan-singh-51914a243"
              target="_singh"
            >
            ...
            <a
              className="icon"
              href="https://github.com/Singhji2003"
              target="_singh"
            >
            ...
            <a
              className="icon"
              href="https://www.instagram.com/arpan_singhji/"
              target="_singh"
            >
          ...
          <div className="resume-button">
            <a href={require("./Arpan-Resume.pdf")} download="Resume-Arpan">
        ...
        <div className="image-heading">
          <img
            src={require("./Image/arpanimg.jpeg")}
            alt=""
            data-aos="flip-right"
          />
        </div>
